...
## generate pods, services and deployments
...
````
:exclamation: The usage ``--generator=deployment/v1beta1`` is deprecated as of Kubernetes 1.16. The recommended way is to use the ``kubectl create`` option instead
